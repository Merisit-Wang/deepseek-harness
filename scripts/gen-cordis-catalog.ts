...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SshTarget: 'ssh-remote.md',
  SshTargetId: 'ssh-remote.md',
  SshBackendPhase: 'ssh-remote.md',
  SshBackendStatus: 'ssh-remote.md',
  SshEnsureRequest: 'ssh-remote.md',
  SshEnsureResult: 'ssh-remote.md',
  SshDisconnectRequest: 'ssh-remote.md',

...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/ssh-remote': { kind: 'none', reason: 'SSH provisioning and tunnel lifecycle over the system ssh binary; registers no prompt, tool, or session event.' },
  'packages/experimental/client-ui-ssh-remote': { kind: 'none', reason: 'Browser-side presentation of host-reported backend state; registers nothing model-facing.' },
  'packages/experimental/ssh-remote-web-profile': { kind: 'indirect', reason: 'The Web layer delegates model composition to the two packages it mounts.' },
